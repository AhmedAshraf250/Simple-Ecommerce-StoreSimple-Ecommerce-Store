    ...
    <div class="container p-0">
      <div class="row">
        <div class="col-lg-6 mb-3 mb-lg-0">
          ...
          <p class="text-small text-muted mb-0">Let's talk about everything!</p>
        </div>
        <div class="col-lg-6">
          <form>
            <div class="input-group flex-column flex-sm-row mb-3">
              <input class="form-control form-control-lg py-3 email0" type="email" placeholder="Enter your email address" aria-describedby="button-addon2">
              <div class="input-group-append">
                <button class="btn btn-dark btn-block" id="button-addon2" type="submit">Subscribe</button>
              </div>
            </div>
          </form>
          <!-- <div id="viewRES_danger" class="row"></div> -->
        </div>
      </div>
      <div id="viewRES" class="row d-block text-center"></div>
    </div>
  </section>
</div>
