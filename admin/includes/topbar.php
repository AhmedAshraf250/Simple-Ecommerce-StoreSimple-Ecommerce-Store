            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow mx-1">
                    <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <!-- Counter - Messages -->
                        <span class="badge <?php $sel_view = "SELECT count(*) AS count FROM messages WHERE view = 0 ";
                                            $query = $conn->query($sel_view);
                    ...
                    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                        ...
                        // while ($MSG_SEL_row = $MSG_SEL_query->fetch_assoc())
                        foreach ($MSG_SEL_query as $MSG) {
                        ?>
                            <a class="dropdown-item d-flex align-items-center modalahref " data-toggle="modal" data-target="#MSG_MODAL<?= $MSG['id'] ?>" data-id="<?= $MSG['id'] ?>" href="#">
                                ...
                                <div class="font-weight-bold">
                                    ...
                                    <div class="small text-gray-500"><?= $MSG['name'] ?> . <?= $MSG['phone'] ?></div>
                                </div>
                            </a>
                        <?php
                            $conn->errno;
                        ...
                        <a class="dropdown-item text-center text-gray-500" href="Messages.php">Read More Messages</a>
                    </div>
                </li>
