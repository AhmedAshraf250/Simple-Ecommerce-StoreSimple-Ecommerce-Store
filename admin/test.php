                ...
                <div class="container p-0">
                    <div class="row">
                        ...
                        <div class="col-lg-3 order-2 order-lg-1">
                            ...
                            <a class="py-2 px-4 bg-dark text-white mb-3" href="shop.php"><strong class="small text-uppercase font-weight-bold">ALL Proudcts</strong></a>
                            <hr>
                            <!-- <a class="py-2 px-4 bg-dark text-white mb-3">href="#" </a> -->
                            ...
                            <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                                <?php
                                include "sbadmin2/functions/connect.php";
                                $select_cat = "SELECT * FROM categories";
                                $query_cat = $conn->query($select_cat);
                                foreach ($query_cat as $category) {
                                ?>
                                    <li class="mb-2"><a class="reset-anchor" href="?cat_id=<?= $category['id'] ?>"><?= $category['name'] ?></a></li>
                  ...
                  <li class="mb-2"><a class="reset-anchor" href="#">Men's sunglasses</a></li> -->
                        ...
                        <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                            ...
                            <div class="row">
                                ...
                                //     $cat_id = $_GET['cat_id'];
                                //     $select = "SELECT * FROM products WHERE cat_id = $cat_id LIMIT 2 offset 2";
                                //   }else{
                                //     $select = "SELECT * FROM products LIMIT 2 offset 2";
                                //   }
                                ///
                                $page = 1;
                                if (!empty($_GET['page'])) {
                                ...
                                $select = "SELECT * FROM products LIMIT " . $offset . "," . $items_per_page;
                                ...
                                ?>
                                    <?php
                                    $id_proudct = $proudct['id'];
                                    $select_img = "SELECT * FROM images WHERE pro_id = $id_proudct";
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="product text-center">
                                            <div class="mb-3 position-relative">
                                                <div class="badge text-white badge-"></div><a class="d-block" href="detail.php?id=<?= $proudct['id'] ?>"><img style="max-width: 200px;" class="img-fluid w-100" src="sbadmin2/img/<?= $img['name'] ?>" alt="..."></a>
                                            ...
                                            <h6> <a class="reset-anchor" href="detail.html"><?= $proudct['name'] ?></a></h6>
                                            <p style="text-decoration: line-through;" class="small text-muted">$<?= $proudct['price'] ?></p>
                                            <p class="small text-muted">$<?= $proudct['sale'] ?></p>
                                        </div>
                                    </div>
                                <?php
                                };
